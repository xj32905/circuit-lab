...
Final self-check: all values read accurately? wire junctions aligned? emitter and collector swapped? correct reference ground and source polarity? no unconnected opamp input? component/probe indices count wires? Return valid JSON only.`;
